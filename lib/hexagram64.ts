...
export interface Hexagram {
  ...
  result_level: number;  // 5=🟢 Green Light, 4=🟡 Favorable, 3=🟠 Work for It, 2=🔴 Hold Off, 1=⚫ Not Now
  result_icon: string;
  result_label: string;
  situation: string;
  action_1: string;
...
const HEXAGRAM_SIMPLIFIED: Record<number, {
  ...
  1:  { result_level: 5, result_icon: '🟢', result_label: 'Green Light',         situation: 'Perfect timing and alignment',                action_1: 'Move forward boldly',       action_2: 'Seize the moment',          action_3: 'Lead with confidence' },
  ...
  14: { result_level: 5, result_icon: '🟢', result_label: 'Green Light',      situation: 'Time to reap rewards',             action_1: 'Capitalize on momentum',    action_2: 'Share the gains',           action_3: 'Invest wisely' },
  34: { result_level: 3, result_icon: '🟠', result_label: 'Work for It', situation: 'Strong energy needs direction',                action_1: 'Focus your power',          action_2: 'Pace yourself',             action_3: 'Lead with awareness' },
  5:  { result_level: 3, result_icon: '🟠', result_label: 'Work for It', situation: 'Timing not quite right',                       action_1: 'Prepare thoroughly',        action_2: 'Stay alert',                action_3: 'Cultivate patience' },
  ...
  11: { result_level: 5, result_icon: '🟢', result_label: 'Green Light',      situation: 'Vision aligns with reality',           action_1: 'Trust the flow',            action_2: 'Bridge worlds',             action_3: 'Maintain balance' },
  43: { result_level: 3, result_icon: '🟠', result_label: 'Work for It', situation: 'Decision point approaching',                    action_1: 'Act when ready',            action_2: "Don't hesitate",            action_3: 'Cut cleanly' },
  58: { result_level: 5, result_icon: '🟢', result_label: 'Green Light',      situation: 'Joyful connections',                           action_1: 'Celebrate genuinely',       action_2: 'Spread positivity',         action_3: 'Deepen bonds' },
  10: { result_level: 3, result_icon: '🟠', result_label: 'Work for It', situation: 'Proceed with care',              action_1: 'Step mindfully',            action_2: 'Respect protocols',         action_3: 'Build credibility' },
  38: { result_level: 3, result_icon: '🟠', result_label: 'Work for It', situation: 'Tension and misalignment',                     action_1: 'Find common ground',        action_2: 'Respect differences',       action_3: 'Know when to part' },
  ...
  61: { result_level: 5, result_icon: '🟢', result_label: 'Green Light',      situation: 'Trust-building phase',                         action_1: 'Lead with vulnerability',   action_2: 'Keep promises',             action_3: 'Trust intuition' },
  60: { result_level: 3, result_icon: '🟠', result_label: 'Work for It', situation: 'Need balance and rhythm',                      action_1: 'Set boundaries',            action_2: 'Create rituals',            action_3: 'Moderate extremes' },
  41: { result_level: 2, result_icon: '🔴', result_label: 'Hold Off',     situation: 'Must let something go',                        action_1: 'Identify the cost',         action_2: 'Release gracefully',        action_3: 'Focus on net gain' },
  ...
  30: { result_level: 5, result_icon: '🟢', result_label: 'Green Light',      situation: 'Clarity and visibility peak',          action_1: 'Shine your light',          action_2: 'Clarify vision',            action_3: 'Inspire others' },
  13: { result_level: 5, result_icon: '🟢', result_label: 'Green Light',      situation: 'Finding your tribe',               action_1: 'Find your tribe',           action_2: 'Align on values',           action_3: 'Contribute generously' },
  49: { result_level: 3, result_icon: '🟠', result_label: 'Work for It', situation: 'Transformation needed',                  action_1: 'Release the old',           action_2: 'Lead the change',           action_3: 'Communicate vision' },
  55: { result_level: 5, result_icon: '🟢', result_label: 'Green Light',      situation: 'Peak moment, abundance',                       action_1: 'Savor the moment',          action_2: 'Document learnings',        action_3: 'Prepare for transition' },
  ...
  63: { result_level: 5, result_icon: '🟢', result_label: 'Green Light',      situation: 'Coming full circle',                    action_1: 'Acknowledge completion',    action_2: 'Integrate learnings',       action_3: 'Rest before next' },
  ...
  36: { result_level: 2, result_icon: '🔴', result_label: 'Hold Off',            situation: 'Light temporarily obscured',                   action_1: 'Protect your energy',       action_2: 'Work behind scenes',        action_3: 'Prepare for return' },
  51: { result_level: 3, result_icon: '🟠', result_label: 'Work for It', situation: 'Unexpected shake-up',                action_1: 'Embrace disruption',        action_2: 'Find your center',          action_3: 'Act on insights' },
  ...
  21: { result_level: 3, result_icon: '🟠', result_label: 'Work for It', situation: 'Need clear decisions',                         action_1: 'Make the call',             action_2: 'Execute completely',        action_3: 'Remove obstacles' },
  42: { result_level: 5, result_icon: '🟢', result_label: 'Green Light',      situation: 'Rapid growth phase',                           action_1: 'Invest in growth',          action_2: 'Share gains',               action_3: 'Build systems' },
  3:  { result_level: 2, result_icon: '🔴', result_label: 'Hold Off',     situation: 'Challenging start',                            action_1: 'Start small',               action_2: 'Build foundations',         action_3: 'Persist through difficulty' },
  ...
  28: { result_level: 2, result_icon: '🔴', result_label: 'Hold Off',     situation: 'Overextended',                                 action_1: 'Identify imbalance',        action_2: 'Reduce load',               action_3: 'Reinforce structures' },
  50: { result_level: 3, result_icon: '🟠', result_label: 'Work for It', situation: 'Transformation underway',                      action_1: 'Embrace refining fire',     action_2: 'Release old form',          action_3: 'Shape the new' },
  ...
  18: { result_level: 2, result_icon: '🔴', result_label: 'Hold Off',     situation: 'Rebuilding needed',                            action_1: 'Acknowledge decay',         action_2: 'Root out corruption',       action_3: 'Rebuild with wisdom' },
  46: { result_level: 5, result_icon: '🟢', result_label: 'Green Light',      situation: 'Rising naturally',                    action_1: 'Grow toward light',         action_2: 'Root deeply',               action_3: 'Trust natural timing' },
  29: { result_level: 2, result_icon: '🔴', result_label: 'Hold Off',     situation: 'Navigating uncertain terrain',                 action_1: 'Stay calm',                 action_2: 'Find the current',          action_3: 'Trust your training' },
  6:  { result_level: 2, result_icon: '🔴', result_label: 'Hold Off',     situation: 'Conflict brewing',                             action_1: 'Seek middle ground',        action_2: 'Choose battles wisely',     action_3: 'Focus on interests' },
  47: { result_level: 2, result_icon: '🔴', result_label: 'Hold Off',     situation: 'Feeling constrained',                          action_1: 'Accept constraints',        action_2: 'Find creative solutions',   action_3: 'Conserve resources' },
  64: { result_level: 3, result_icon: '🟠', result_label: 'Work for It', situation: 'Nearly complete',                              action_1: 'Embrace incompleteness',    action_2: 'Focus on direction',        action_3: 'Trust the process' },
  40: { result_level: 5, result_icon: '🟢', result_label: 'Green Light',      situation: 'Difficulty resolving',                         action_1: 'Let go',                    action_2: 'Integrate lessons',         action_3: 'Move forward lightly' },
  59: { result_level: 3, result_icon: '🟠', result_label: 'Work for It', situation: 'Energy and focus are scattered',                 action_1: 'Focus the scatter',         action_2: 'Release unessential',       action_3: 'Gather what matters' },
  ...
  7:  { result_level: 3, result_icon: '🟠', result_label: 'Work for It', situation: 'Team coordination needed',                     action_1: 'Clarify roles',             action_2: 'Build trust',               action_3: 'Lead by example' },
  52: { result_level: 3, result_icon: '🟠', result_label: 'Work for It', situation: 'Time to stop, pause',                          action_1: 'Stop completely',           action_2: 'Observe from stillness',    action_3: 'Wait for signal' },
  33: { result_level: 2, result_icon: '🔴', result_label: 'Hold Off',     situation: 'Strategic withdrawal',                         action_1: 'Step back gracefully',      action_2: 'Preserve energy',           action_3: 'Prepare for return' },
  31: { result_level: 5, result_icon: '🟢', result_label: 'Green Light',      situation: 'Mutual attraction',                            action_1: 'Follow attraction',         action_2: 'Check reciprocity',         action_3: 'Build on resonance' },
  ...
  62: { result_level: 3, result_icon: '🟠', result_label: 'Work for It', situation: 'Minor imbalance',                              action_1: 'Mind the details',          action_2: 'Avoid major risks',         action_3: 'Correct quickly' },
  ...
  39: { result_level: 2, result_icon: '🔴', result_label: 'Hold Off',     situation: 'Facing obstacles',                             action_1: 'Accept difficulty',         action_2: 'Find another way',          action_3: 'Ask for help' },
  15: { result_level: 5, result_icon: '🟢', result_label: 'Green Light',      situation: 'Quiet strength prevails',                 action_1: 'Let results speak',         action_2: 'Acknowledge others',        action_3: 'Stay grounded' },
  ...
  12: { result_level: 2, result_icon: '🔴', result_label: 'Hold Off',     situation: 'Connection blocked',                           action_1: 'Acknowledge the block',     action_2: "Don't force connection",    action_3: 'Wait for opening' },
  45: { result_level: 5, result_icon: '🟢', result_label: 'Green Light',      situation: 'Coming together',                          action_1: 'Call people together',      action_2: 'Create container',          action_3: 'Honor contributions' },
  35: { result_level: 5, result_icon: '🟢', result_label: 'Green Light',      situation: 'Advancing forward',                     action_1: 'Step into light',           action_2: 'Prepare for responsibility', action_3: 'Help others rise' },
  ...
  20: { result_level: 5, result_icon: '🟢', result_label: 'Green Light',      situation: 'Steady upward climb',                        action_1: 'Grow toward light',         action_2: 'Root deeply',               action_3: 'Trust natural timing' },
  8:  { result_level: 5, result_icon: '🟢', result_label: 'Green Light',      situation: 'Building alliances',                            action_1: 'Reach out',                 action_2: 'Offer support first',       action_3: 'Choose allies carefully' },
  23: { result_level: 2, result_icon: '🔴', result_label: 'Hold Off',     situation: 'Natural decline',                              action_1: 'Let it fall',               action_2: 'Protect the core',          action_3: 'Prepare for renewal' },
};
