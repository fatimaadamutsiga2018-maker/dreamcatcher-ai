...
export const metadata: Metadata = {
  title: "Why Doing Nothing Can Be Rational — Dreamcatcher",
  description: "In low-leverage environments, restraint preserves optionality. The case for strategic pause as a legitimate decision.",
  alternates: {
